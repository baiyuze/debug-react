...
const reactPath = path.join(__dirname, "./src/react");
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        'react-events': path.join(process.cwd(), './src/react/packages/events'),
        "legacy-events": path.join(process.cwd(), "./src/react/packages/legacy-events"),
